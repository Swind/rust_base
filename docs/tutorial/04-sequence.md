...
> 本章是整個系列的核心。
> Chromium 素材：`reference/threading_and_tasks.md` 的 Posting a Sequenced
> Task、Using Sequences Instead of Locks、Prefer Sequences to Physical Threads
> 三節、[`reference/base/task/sequenced_task_runner.h`](../../reference/base/task/sequenced_task_runner.h)、
> [`reference/base/task/thread_pool/sequence.h`](../../reference/base/task/thread_pool/sequence.h)。
> Rust 素材：Rust Book [ch15-03 Drop](../../reference/book/src/ch15-03-drop.md)、
> [ch15-05 RefCell 與內部可變性](../../reference/book/src/ch15-05-interior-mutability.md)、
> [ch15-06 引用循環](../../reference/book/src/ch15-06-reference-cycles.md)、
> [ch16-03 共享狀態](../../reference/book/src/ch16-03-shared-state.md)、
> [ch20-02 進階 trait（supertrait）](../../reference/book/src/ch20-02-advanced-traits.md)。
...
必須先實作 `TaskRunner`」（[ch20-02](../../reference/book/src/ch20-02-advanced-traits.md)）。
...
檢查，違反就 panic（[ch15-05](../../reference/book/src/ch15-05-interior-mutability.md)）。
...
`Drop::drop`（[ch15-03](../../reference/book/src/ch15-03-drop.md)）在值離開
...
〔Rust 基礎〕先補 `Mutex` 的基本面（[ch16-03](../../reference/book/src/ch16-03-shared-state.md)）。
...
**雙雙洩漏**（[ch15-06](../../reference/book/src/ch15-06-reference-cycles.md)）。
...
`None`。對應 Chromium 的 `base::WeakPtr`（`reference/base/memory/weak_ptr.h`），
...
- Chromium `sequence.h`（`reference/base/task/thread_pool/sequence.h`）開頭
